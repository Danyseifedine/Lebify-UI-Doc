import{r as c,j as e,L as u}from"./app-BdZqqBdK.js";import{D as x}from"./docs-layout-AalQkUTi.js";import{D as l,a,C as s}from"./code-block-DwHcGNIV.js";import{m as h,O as t,S as b}from"./navbar-DbZlJiIa.js";import{a as I}from"./button-BD1LFRFg.js";import{E as p}from"./eye-D1-zsN0W.js";import{M as f}from"./mail-DhSVhqdt.js";import{L as y,U as j}from"./user-u4j0uGf3.js";import"./app-logo-CyLHPJe5.js";import"./index-6WaSp8Bo.js";import"./index-DQWQAJ7X.js";import"./check-BZJTnSfN.js";import"./sun-BgzP_e67.js";/**
 * @license lucide-react v0.475.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const g=[["path",{d:"M10.733 5.076a10.744 10.744 0 0 1 11.205 6.575 1 1 0 0 1 0 .696 10.747 10.747 0 0 1-1.444 2.49",key:"ct8e1f"}],["path",{d:"M14.084 14.158a3 3 0 0 1-4.242-4.242",key:"151rxh"}],["path",{d:"M17.479 17.499a10.75 10.75 0 0 1-15.417-5.151 1 1 0 0 1 0-.696 10.75 10.75 0 0 1 4.446-5.143",key:"13bj9a"}],["path",{d:"m2 2 20 20",key:"1ooewy"}]],d=I("EyeOff",g);function k(){const[r,n]=c.useState(!1),[i,o]=c.useState("");return e.jsxs(x,{tocItems:[{title:"Introduction",url:"#introduction",level:1},{title:"Basic Variants",url:"#basic-variants",level:1},{title:"Lebanese Collections",url:"#lebanese-collections",level:1},{title:"Additional Variants",url:"#additional-variants",level:1},{title:"Input Types",url:"#input-types",level:1},{title:"Sizes",url:"#sizes",level:1},{title:"With Icons",url:"#with-icons",level:1},{title:"States",url:"#states",level:1},{title:"API Reference",url:"#api-reference",level:1}],children:[e.jsx(u,{title:"Input - Lebify UI"}),e.jsxs(h.div,{initial:{opacity:0,y:20},animate:{opacity:1,y:0},className:"space-y-12 max-w-3xl",children:[e.jsxs("div",{className:"space-y-4",children:[e.jsx("h1",{id:"introduction",className:"scroll-m-20 text-5xl pb-3 font-bold tracking-tight main-title bg-gradient-to-r from-primary to-secondary bg-clip-text text-transparent",children:"Input"}),e.jsx("p",{className:"text-xl text-muted-foreground",children:"A versatile input component with Lebanese-inspired variants, multiple styles, and interactive features."})]}),e.jsxs("div",{className:"space-y-10",children:[e.jsxs(l,{id:"basic-variants",title:"Basic Variants",size:"3xl",children:[e.jsx(a,{children:"Lebify UI provides a set of basic input variants to cover common use cases."}),e.jsxs("div",{className:"flex flex-col gap-4 my-6",children:[e.jsx(t,{variant:"primary",label:"Primary Input",placeholder:"Enter text here"}),e.jsx(t,{variant:"secondary",label:"Secondary Input",placeholder:"Enter text here"}),e.jsx(t,{variant:"tertiary",label:"Tertiary Input",placeholder:"Enter text here"}),e.jsx(t,{variant:"basic",label:"Basic Input",placeholder:"Enter text here"})]}),e.jsx(s,{language:"typescript",code:`import { Input } from 'lebify-ui';
...
<Input variant="basic" label="Basic Input" placeholder="Enter text here" />`})]}),e.jsxs(l,{id:"lebanese-collections",title:"Lebanese-Inspired Collections",size:"3xl",children:[e.jsx(a,{children:"Lebify UI features unique input collections inspired by Lebanese culture, landscapes, and heritage."}),e.jsxs("div",{className:"space-y-6",children:[e.jsxs("div",{children:[e.jsx("h3",{className:"text-lg font-medium mb-3",children:"Cedar Collection"}),e.jsxs("div",{className:"flex flex-col gap-4 mb-4",children:[e.jsx(t,{variant:"cedar",label:"Cedar Input",placeholder:"Enter text here"}),e.jsx(t,{variant:"cedar-light",label:"Cedar Light Input",placeholder:"Enter text here"}),e.jsx(t,{variant:"cedar-dark",label:"Cedar Dark Input",placeholder:"Enter text here"})]})]}),e.jsxs("div",{children:[e.jsx("h3",{className:"text-lg font-medium mb-3",children:"Mediterranean Collection"}),e.jsxs("div",{className:"flex flex-col gap-4 mb-4",children:[e.jsx(t,{variant:"sea",label:"Sea Input",placeholder:"Enter text here"}),e.jsx(t,{variant:"coast",label:"Coast Input",placeholder:"Enter text here"}),e.jsx(t,{variant:"azure",label:"Azure Input",placeholder:"Enter text here"})]})]})]}),e.jsx(s,{language:"typescript",code:`// Cedar Collection
...
// Mountain Collection, Beirut Collection, Culinary Collection, etc.`})]}),e.jsxs(l,{id:"additional-variants",title:"Additional Variants",size:"3xl",children:[e.jsx(a,{children:"Lebify UI offers a range of stylistic variants to match different design aesthetics."}),e.jsxs("div",{className:"flex flex-col gap-4 my-6",children:[e.jsx(t,{label:"Glass Input",placeholder:"Glassmorphism effect",variant:"glass"}),e.jsx(t,{label:"Neomorphic Input",placeholder:"Soft UI effect",variant:"neomorphic"}),e.jsx(t,{label:"Gradient Input",placeholder:"Gradient effect",variant:"gradient"}),e.jsx(t,{label:"Minimal Input",placeholder:"Clean minimal design",variant:"minimal"}),e.jsx(t,{label:"Dark Input",placeholder:"Dark mode design",variant:"dark"}),e.jsx(t,{label:"Pill Input",placeholder:"Rounded pill design",variant:"pill"}),e.jsx(t,{label:"Flat Input",placeholder:"Modern flat design",variant:"flat"})]}),e.jsx(s,{language:"typescript",code:`import { Input } from 'lebify-ui';
...
<Input
  ...
  variant="flat"
/>`})]}),e.jsxs(l,{id:"input-types",title:"Input Types",size:"3xl",children:[e.jsx(a,{children:"The Input component supports various input types to handle different data formats."}),e.jsxs("div",{className:"flex flex-col gap-4 my-6",children:[e.jsx(t,{type:"text",label:"Text Input",placeholder:"Enter text"}),e.jsx(t,{type:"password",label:"Password Input",placeholder:"Enter password",rightIcon:e.jsx("button",{onClick:()=>n(!r),type:"button",children:r?e.jsx(d,{className:"h-4 w-4"}):e.jsx(p,{className:"h-4 w-4"})})}),e.jsx(t,{type:"email",label:"Email Input",placeholder:"example@email.com"}),e.jsx(t,{type:"number",label:"Number Input",placeholder:"Enter a number",min:0,max:100}),e.jsx(t,{type:"date",label:"Date Input"}),e.jsx(t,{type:"time",label:"Time Input"}),e.jsx(t,{type:"textarea",label:"Textarea",placeholder:"Enter multiple lines of text",rows:3}),e.jsx(t,{type:"select",label:"Select Input",options:[{value:"option1",label:"Option 1"},{value:"option2",label:"Option 2"},{value:"option3",label:"Option 3"}]})]}),e.jsx(s,{language:"typescript",code:`import { Input } from 'lebify-ui';
...
}`})]}),e.jsxs(l,{id:"sizes",title:"Sizes",size:"3xl",children:[e.jsx(a,{children:"The Input component comes in four different sizes to fit various UI requirements."}),e.jsxs("div",{className:"flex flex-col gap-4 my-6",children:[e.jsx(t,{label:"Small Input",placeholder:"Small size",size:"small",variant:"basic"}),e.jsx(t,{label:"Compact Input",placeholder:"Compact size",size:"compact",variant:"basic"}),e.jsx(t,{label:"Medium Input",placeholder:"Medium size (default)",size:"medium"}),e.jsx(t,{label:"Large Input",placeholder:"Large size",size:"large"})]}),e.jsx(s,{language:"typescript",code:`import { Input } from 'lebify-ui';
...
<Input
  ...
  size="large"
/>`})]}),e.jsxs(l,{id:"with-icons",title:"With Icons",size:"3xl",children:[e.jsx(a,{children:"Inputs can include icons on either side to provide visual cues or additional functionality."}),e.jsxs("div",{className:"flex flex-col gap-4 my-6",children:[e.jsx(t,{label:"Email Input",placeholder:"Enter your email",type:"email",leftIcon:e.jsx(f,{className:"h-4 w-4"})}),e.jsx(t,{label:"Password Input",placeholder:"Enter your password",type:"password",leftIcon:e.jsx(y,{className:"h-4 w-4"}),rightIcon:e.jsx("button",{onClick:()=>n(!r),type:"button",children:r?e.jsx(d,{className:"h-4 w-4"}):e.jsx(p,{className:"h-4 w-4"})})}),e.jsx(t,{label:"Search Input",placeholder:"Search...",value:i,onChange:m=>o(m.target.value),leftIcon:e.jsx(b,{className:"h-4 w-4"}),rightIcon:i?e.jsx("button",{onClick:()=>o(""),type:"button",className:"text-muted-foreground hover:text-foreground",children:"×"}):null}),e.jsx(t,{label:"Username Input",placeholder:"Enter username",leftIcon:e.jsx(j,{className:"h-4 w-4"})})]}),e.jsx(s,{language:"typescript",code:`import { Input } from 'lebify-ui';
...
console.log(Input.BORDER_RADIUS.PILL);   // 'pill'`})]})]})]})]})}export{k as default};

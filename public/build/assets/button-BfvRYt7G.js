...
<Button variant="startup">Startup</Button>`})]}),e.jsxs(a,{id:"sizes",title:"Sizes",size:"3xl",children:[e.jsx(n,{children:"Buttons come in three different sizes to fit various UI contexts."}),e.jsxs("div",{className:"flex items-center gap-4 my-6",children:[e.jsx(t,{size:"small",children:"Small"}),e.jsx(t,{size:"medium",children:"Medium"}),e.jsx(t,{size:"large",children:"Large"})]}),e.jsx(s,{language:"typescript",code:`<Button size="small">Small</Button>
<Button size="medium">Medium</Button>
<Button size="large">Large</Button>`})]}),e.jsxs(a,{id:"button-types",title:"Button Types",size:"3xl",children:[e.jsx(n,{children:"Lebify UI supports different button types to match your design needs."}),e.jsxs("div",{className:"flex flex-wrap gap-4 my-6",children:[e.jsx(t,{buttonType:"filled",children:"Filled"}),e.jsx(t,{buttonType:"outlined",children:"Outlined"}),e.jsx(t,{buttonType:"ghost",children:"Ghost"})]}),e.jsx(s,{language:"typescript",code:`<Button buttonType="filled">Filled Button</Button>
<Button buttonType="outlined">Outlined Button</Button>
<Button buttonType="ghost">Ghost Button</Button>`})]}),e.jsxs(a,{id:"with-icons",title:"With Icons",size:"3xl",children:[e.jsx(n,{children:"Buttons can include icons to enhance visual communication. Icons can be positioned on either side of the text."}),e.jsxs("div",{className:"flex flex-wrap gap-4 my-6",children:[e.jsx(t,{icon:e.jsx(l,{className:"h-4 w-4"}),iconPosition:"left",children:"Login with Email"}),e.jsx(t,{icon:e.jsx(c,{className:"h-4 w-4"}),iconPosition:"right",children:"Download"}),e.jsx(t,{icon:e.jsx(d,{className:"h-4 w-4"}),iconOnly:!0,"aria-label":"Confirm"})]}),e.jsx(s,{language:"typescript",code:`// Icon on the left
<Button
...
</Button>`})]}),e.jsxs(a,{id:"loading-state",title:"Loading State",size:"3xl",children:[e.jsx(n,{children:"Buttons can display a loading state to indicate an ongoing operation. You can customize the loading spinner and text."}),e.jsxs("div",{className:"flex flex-wrap gap-4 my-6",children:[e.jsx(t,{loading:!0,loadingText:"Please wait",children:"Submit"}),e.jsx(t,{variant:"secondary",loading:!0,loadingSpinner:"dots",loadingPosition:"right",children:"Processing"}),e.jsx(t,{variant:"cedar",loading:!0,loadingSpinner:"pulse",hideTextWhenLoading:!0,children:"Save"})]}),e.jsx(s,{language:"typescript",code:`// Basic loading button
...
console.log(Button.LOADING_SPINNER.ELLIPSIS); // 'ellipsis'`})]})]})]})]})}export{S as default};

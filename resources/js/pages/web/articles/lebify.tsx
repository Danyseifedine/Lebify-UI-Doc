...
<p>The count is {$count}</p>`} />
                        ...
                        {/* Svelte Transitions */}
                        <div className="bg-gray-50 dark:bg-gray-900 p-4 md:p-8 rounded-2xl mt-12">
                            <div className="flex flex-col md:flex-row md:items-center mb-4 md:mb-6">
                                <div
                                    className="w-12 h-12 md:w-16 md:h-16 bg-orange-100 dark:bg-orange-900/30 rounded-full flex items-center justify-center mb-4 md:mb-0 md:mr-6">
                                    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 md:h-8 md:w-8 text-orange-500"
                        ...
                        <div className="overflow-x-auto mb-8">
                            <table className="min-w-full bg-white dark:bg-gray-800 rounded-xl overflow-hidden shadow-lg">
                                <thead className="bg-gray-100 dark:bg-gray-700">
                                    <tr>
                                        <th className="py-3 px-4 text-left text-gray-900 dark:text-white">Framework</th>
                                        <th className="py-3 px-4 text-left text-gray-900 dark:text-white">Learning Curve</th>
                                        <th className="py-3 px-4 text-left text-gray-900 dark:text-white">Performance</th>
                                        <th className="py-3 px-4 text-left text-gray-900 dark:text-white">Best For</th>
                                    </tr>
                                </thead>
                                <tbody className="divide-y divide-gray-200 dark:divide-gray-600">
                                    <tr>
                                        <td className="py-3 px-4 text-gray-800 dark:text-gray-200 font-medium">React</td>
                                        <td className="py-3 px-4 text-gray-800 dark:text-gray-200">Moderate</td>
                                        <td className="py-3 px-4 text-gray-800 dark:text-gray-200">Good</td>
                                        <td className="py-3 px-4 text-gray-800 dark:text-gray-200">Large, complex applications with extensive ecosystems</td>
                                    </tr>
                                    <tr>
                                        <td className="py-3 px-4 text-gray-800 dark:text-gray-200 font-medium">Vue.js</td>
                                        <td className="py-3 px-4 text-gray-800 dark:text-gray-200">Easy</td>
                                        <td className="py-3 px-4 text-gray-800 dark:text-gray-200">Very Good</td>
                                        <td className="py-3 px-4 text-gray-800 dark:text-gray-200">Progressive enhancement, gradual adoption</td>
                                    </tr>
                                    <tr>
                                        <td className="py-3 px-4 text-gray-800 dark:text-gray-200 font-medium">Angular</td>
                                        <td className="py-3 px-4 text-gray-800 dark:text-gray-200">Steep</td>
                                        <td className="py-3 px-4 text-gray-800 dark:text-gray-200">Good</td>
                                        <td className="py-3 px-4 text-gray-800 dark:text-gray-200">Enterprise applications, large teams with TypeScript</td>
                                    </tr>
                                    <tr>
                                        <td className="py-3 px-4 text-gray-800 dark:text-gray-200 font-medium">Svelte</td>
                                        <td className="py-3 px-4 text-gray-800 dark:text-gray-200">Easy</td>
                                        <td className="py-3 px-4 text-gray-800 dark:text-gray-200">Excellent</td>
                                        <td className="py-3 px-4 text-gray-800 dark:text-gray-200">Performance-critical applications, smaller bundles</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>

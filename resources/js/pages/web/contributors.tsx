...
{
    id: 5,
    name: "Ahmad Seifeddine",
    position: "Co-Founder of Lebify / Full-Stack Developer",
...
return (
<CodeThemeProvider>
    <WebLayout title="Lebify - Contributors" description="Meet the people who make Lebify possible">
        {/* Hero Section */}
                ...
                <div className="flex flex-col md:flex-row items-center justify-between gap-12">
                    ...
                    <div className="w-full md:w-1/2">
                        <motion.div initial={{ opacity: 0, x: -20 }} animate={{ opacity: 1, x: 0 }}
                            ...
                            <img src="/assets/images/contributors.png" alt="Contributors Hero"
                    ...
                    <div className="w-full md:w-1/2">
                        <motion.h1
                            ...
                            Our amazing <span className="text-orange-600 dark:text-orange-400">Contributors</span>
                        </motion.h1>

                        <motion.p className="text-xl text-gray-700 dark:text-gray-300 pt-4"
                            initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}
                            transition={{ duration: 0.6, delay: 0.4 }}>
                            Meet the people who make Lebify possible.
                        </motion.p>
                    </div>
                </div>
            </div>
        ...
        <section className="bg-white dark:bg-black py-20">
            <div className="container mx-auto px-6">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
                    ...
                    >
                        {/* Auto-sized container that will match image dimensions */}
                        <div className="relative rounded-xl overflow-hidden shadow-lg w-auto inline-block cursor-pointer">
                            {/* Image with natural dimensions */}
                            <div className="relative">
                                <img
                                    src={contributor.image}
                                    alt={contributor.name}
                                    className="w-auto h-auto max-w-full object-contain filter grayscale group-hover:grayscale-0 transition-all duration-300 ease-out"
                                />

                                {/* Overlay Gradient - Sized to match image */}
                                <div className="absolute inset-0 bg-gradient-to-t from-black/90 via-black/50 to-black/30 opacity-80 transition-opacity duration-300"></div>
                            </div>
